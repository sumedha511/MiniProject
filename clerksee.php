...
{
      ?><h1>Students information is not available</h1>
<?php
}
...
<tr>  
 ...
 while ($row = mysqli_fetch_array($result)) {
        ...
        <tr>
            ...
            <td><center><?php echo $row['dept_id']; ?></center></td> 
...
{
      ?><h1>Department information is not available</h1>
<?php
}
...
{
      ?><h1>Subject information is not available</h1>
<?php
}
