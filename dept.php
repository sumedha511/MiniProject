...
<button1 onclick='location.href="searchd.php"' style="float:right;"> Search</button1><right>
...
<fieldset>
  ...
  <?php
$sql1="select count(dept_id) from department";
...
?>
 Department name:<br>
  ...
  Department ID:<br>
<input type="text" name="deptid1" value="<?php echo $max;?>" required>
  <br><br>
...
<br>
    <center><input type="submit" value="submit" formaction=""></center>
</form> 
</center>
<?php
if(isset($_POST['deptid1'],$_POST['deptname']))
{
$deptname1=$_POST[ 'deptname' ];
$deptid=$_POST[ 'deptid1' ];


$sql1="insert into department(dept_id,dept_name) values('$deptid','$deptname1');";
$result1=mysqli_query($conn,$sql1);
